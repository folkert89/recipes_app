...
import { FETCHED_RECIPES } from  '../actions/recipes/recipes'
import { FETCHED_ONE_RECIPE } from '../actions/recipes/recipes'
...
export default (state= recipes, {type, payload} = {}) => {
  switch(type) {
    case CREATE_RECIPE: return [Object.assign({}, payload)].concat(state)
    case FETCHED_RECIPES :  return payload.slice()
